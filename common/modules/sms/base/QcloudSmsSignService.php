...
{
    const SIGN_ADD_URL = 'https://yun.tim.qq.com/v5/tlssmssvr/add_sign';
    const SIGN_UPDATE_URL = 'https://yun.tim.qq.com/v5/tlssmssvr/mod_sign';
    const SIGN_CHECK_URL = 'https://yun.tim.qq.com/v5/tlssmssvr/get_sign';
     ...
     *                     }
     */
    public function update($sign_id, $sign, $desc)
    {
        $this->url = self::SIGN_UPDATE_URL;
        $random = $this->util->getRandom();
        $curTime = time();
        $wholeUrl = $this->url . "?sdkappid=" . $this->appid . "&random=" . $random;
